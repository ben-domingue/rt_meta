...
w3<-read.csv("/home/bd/Dropbox/projects/rt_meta/data/0_raw/nshap/nshap_w3_moca_times.csv")
...
save(x,file=paste("/home/bd/Dropbox/projects/rt_meta/data/1_raw_main/raw_nshap.Rdata",sep=""))
