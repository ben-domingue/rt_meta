...
## library(sas7bdat)
## rt<-read.sas7bdat("~/Dropbox/projects/rt_meta/data/0_raw/pisa2018/TIM/cy07_msu_stu_tim.sas7bdat")
library(foreign)
options(warn=-10)
## rt<-read.spss("./TIM/CY07_MSU_STU_TIM.sav",
##               to.data.frame=TRUE,
##               use.value.labels=FALSE
##               )
x<-read.spss("./COG/CY07_MSU_STU_COG.sav",
              to.data.frame=TRUE,
              use.value.labels=FALSE
              )
options(warn=1)
...
save(x,file="raw_pisa2018.Rdata")
